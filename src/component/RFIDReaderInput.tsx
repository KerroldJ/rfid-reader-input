...
export function RFIDReaderInput({ isOpen, onRequestClose, handleCodeCardRFID, textTitle = 'CASHLESS PAYMENT SYSTEM', textBody = 'PLEASE SCAN YOUR ID' }: CardReaderProps) {
